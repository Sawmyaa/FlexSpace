...
const ASignUp = () => {
    ...
    return (
        <div className='signup-bg-image vh-100'>
            ...
            <div className='signup-card-position' style={{marginTop:"100px"}}>

                <div className="card w-50 mx-auto">
                    <div className="card-body">
                        <h1 className="card-title text-center">CREATE ADMIN ACCOUNT</h1>
            ...
            <input required type="text" className='form-control mb-3' name="organisation" onChange={handleChange} value={values.organisation} /> */}
                        ...
                        <p className='text-center'>Already have account? <Link to='/main/alogin'>LogIn</Link></p>
